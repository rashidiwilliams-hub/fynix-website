...
const projects = [
  { title: "Tempo",            type: "Mobile & Web App",    image: "/carousel-01.png", wide: false },
  { title: "Fynix Admin",      type: "Web Dashboard",       image: "/carousel-02.png", wide: false },
  { title: "Caribbean Eats",   type: "Food Delivery App",   image: "/carousel-03.png", wide: true  },
  { title: "Prestige Autos",   type: "Automotive Website",  image: "/carousel-04.png", wide: false },
  { title: "WMC Engineering",  type: "Corporate Website",   image: "/carousel-05.png", wide: false },
];
    ...
    <section id="portfolio" style={{ background: "#FAFAFA", paddingTop: 100, paddingBottom: 100 }}>
      ...
      <div style={{ maxWidth: 1440, margin: "0 auto", paddingLeft: PAD, paddingRight: PAD }}>
        ...
        <div style={{ marginBottom: 20, textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "clamp(1.8rem,3.5vw,2.8rem)", fontWeight: 800, color: "#0D0D0D", lineHeight: 1.15, letterSpacing: "-0.02em", maxWidth: 680, margin: "0 auto 16px" }}>
